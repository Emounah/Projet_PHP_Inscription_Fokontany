<?php
    ...
    if (isset($_POST["btnusersModifier"])) {
        $errorusers = updateUsers(intval($_GET["idusers"]),$_GET["image"]);
    }
                    ...
                    <div class="card-body">
                      ...
                      <?php foreach($user as $users) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" value="<?=$users["idsektera"]?>" name="idSektera" class="form-control" id="idSektera"
                                    placeholder="Sektera" readonly>
                            </div>
                           <label for="">Sektera : </label>
                            <div class="form-group select-box">
                                <div class="select-option">
                                    <input type="text" value="<?=$users["nomSecteur"]?>" name="nomSektera" placeholder="Safidio ny Sektera" id="soValue"
                                        readonly>
                                </div>
                                <div class="content">
                                    <div class="search">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger btn-round"
                                                name="btnusersModifier">Eny</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
